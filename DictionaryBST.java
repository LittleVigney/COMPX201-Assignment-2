public class DictionaryBST{
    ...
    public void insert(String goal, String goalDef){
        root = insertR(this.root, goal, goalDef);
    }

    public DictionaryNode insertR(DictionaryNode currentRoot, String goal, String goalDef){
        // if root is empty, add it here
        if (currentRoot == null){
            currentRoot = new DictionaryNode(goal, goalDef);
        }

        // if goal is smaller than root
        if (goal.compareTo(currentRoot.value) < 0){
            currentRoot.left = insertR(currentRoot.left, goal, goalDef);
        }

        // if goal is greater than root
        if (goal.compareTo(currentRoot.value) > 0){
            currentRoot.right = insertR(currentRoot.right, goal, goalDef);
        }

        return currentRoot;
    }

    public DictionaryNode search(String goal){
        return searchR(root, goal);
    }

    private DictionaryNode searchR(DictionaryNode currentRoot, String goal){
        DictionaryNode res = currentRoot;
    ...
    private void printR(DictionaryNode currentRoot){
    ...
    public DictionaryNode removeR(DictionaryNode currentRoot, String goal){
        // if reach null node
        if (currentRoot == null){
        ...
        // if goal is found
            ...
            // if goal has two child
                ...
                DictionaryNode newRoot = findLeftMost(currentRoot.right);
    ...
    public DictionaryNode findLeftMost(DictionaryNode goal){
        DictionaryNode currentRoot = goal;
    ...
    public void printDictionaryItem(String goal){
        DictionaryNode goalNode = this.search(goal);
        ...
        if (goalNode == null){
            ...
            System.out.println(goalNode.def);
        }
    }
    ...
    public void printDictionaryR(DictionaryNode currentNode){
        if (currentNode == null){
            return;
        }
        else{
            // do left subtree
            printDictionaryR(currentNode.left);

            // print root
            System.out.println(currentNode.value);
            System.out.println(currentNode.def);
            System.out.println();

            // do right subtree
            printDictionaryR(currentNode.right);
        }
    }
}
